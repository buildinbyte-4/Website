...
import { createClearSessionCookieOptions, getSessionCookieName } from '@/lib/auth/session';
...
export async function POST(request) {
  try {
    ...
    response.cookies.set(getSessionCookieName(), '', createClearSessionCookieOptions());
