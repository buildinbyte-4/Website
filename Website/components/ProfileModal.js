  ...
  return (
    <div className="fixed inset-0 w-screen h-screen flex items-center justify-center bg-[rgba(0,0,0,0.6)] z-50 overflow-y-auto p-4">
      <div className="max-w-md w-full bg-[#FFFFFF] border-2 border-[#000000] p-8 shadow-[6px_6px_0px_#000000] space-y-6 my-auto relative text-center">
        ...
        {errorMsg && (
          <div className="p-3 bg-[#FEE2E2] border-2 border-[#000000] rounded text-xs font-bold text-[#000000] text-left">
            ⚠️ {errorMsg}
          </div>
        )}

        {successMsg && (
          <div className="p-3 bg-[#DCFCE7] border-2 border-[#000000] rounded text-xs font-bold text-[#000000] text-left">
            ✓ {successMsg}
          </div>
        )}
            ...
            <div className="flex flex-col items-center gap-3">
              {avatarUrl ? (
                <img
                  ...
                  className="w-20 h-20 rounded-full object-cover border-2 border-[#000000] shadow-[2px_2px_0px_#000000] bg-[#FFFFFF]"
                />
              ) : (
